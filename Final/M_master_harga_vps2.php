...
class M_master_harga extends CI_Model {
    ...
    public function proses_hpp_broiler_harian($id_harga)
    {
        ...
        if ($ongkos_ovk == 0 || $daya_hidup_persen == 0 || $biaya_operasional == 0 || $target_profit == 0) {
        ...
        $konstanta_tambahan = ((($ongkos_ovk * 100) / $daya_hidup_desimal) + $biaya_operasional + $target_profit) / 2;
