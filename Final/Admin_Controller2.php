...
class Admin_Controller extends CI_Controller {
    ...
    private function _update_data($kategori, $update_data, $user, $page, $id, $existing_data) {
        ...
        switch($kategori) {
            ...
            case 'Harga':
                ...
                // 2. Cek untuk DOC terlebih dahulu
                if ($update_status && isset($nama_harga) && stripos($nama_harga, 'DOC') !== false) {
                    ...
                    $manual_to_daily_map = [
                        ...
                        'Average Cost Komplit Broiler'    => 'cost_komplit_broiler', // TAMBAHKAN INI
                        // Harga Pakan Pre Stater, Stater, Finisher DIHAPUS (tidak ada di map)
                        'Ongkos Kirim'                    => 'ongkos_kirim', // TETAP DIPERTAHANKAN
    ...
    private function _delete_pakan_options($existing_data) {
        ...
        // KUNCI PERBAIKAN: Filter juga berdasarkan tipe ternak
    ...
    private function _delete_strain_options($existing_data) {
        ...
        foreach ($questions as $question) {
            if ($question['field_name'] === 'nama_strain' && !empty($existing_data['nama_strain'])) {
                ...
                // KUNCI PERBAIKAN: Tambahkan tipe_ternak ke kondisi WHERE
