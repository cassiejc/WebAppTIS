...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function createGrouped100PercentStackedChart(canvasId, lalatDatasets, kotoranDatasets, chartLabels) {
            ...
            var lalatColors = { 'Normal': '#fd1d1dff', 'Sedikit': '#90ee90', 'Sedang': '#ffc107', 'Banyak': '#174eadff' };
            var kotoranColors = { 'Kering': '#efa3d4ff', 'Lembab': '#4169e1', 'Basah': '#8dbeffff', 'Normal': '#6c757d' };
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    ...
                                    if (!isNaN(val)) {
                                        if (context.dataset.label.includes('Suhu')) label += val.toFixed(2) + ' °C';
                        ...
                        datalabels: {
                            ...
                            formatter: function(v, ctx) { 
                                ...
                                if (ctx.dataset.label.includes('Suhu')) return val.toFixed(2) + ' °C';
