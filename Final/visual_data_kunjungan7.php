                                ...
                                <table class="table table-hover mb-0">
                                    <thead style="background-color: #f8f9fa; position: sticky; top: 0; z-index: 10;">
                                        <tr>
                                            ...
                                            <th style="border-top: none;" class="text-center">Target Global</th>
                                            <th style="border-top: none;" class="text-center">Aktual Global</th>
                                            <th style="border-top: none;" class="text-center">Pencapaian Global</th>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterLogTable(username, reset = false) {
        ...
        if (!hasData) {
            const colspan = allLogRows.length > 0 ? allLogRows[0].cells.length : 13;
            logTableBody.insertAdjacentHTML('beforeend', `
                <tr class="no-data-filter">
                    <td colspan="${colspan}" class="text-center py-5 text-muted">
                        <i class="fas fa-inbox fa-3x mb-3 d-block" style="opacity: 0.3;"></i>
    ...
    function filterLogByComposition(kategori) {
        ...
        const nonOtherVisits = ['Layer', 'Agen', 'Sub Agen', 'Kantor', 'Koordinasi', 'Grower', 'New Customers', 'Seminar', 'CRM Broiler', 'CRM DOC'];   
        if (kategori === 'Layer') {
        ...
        allLogRows.forEach(row => {
            ...
            if (show && activeKategori) {
                ...
                const nonOtherVisits = [
                    ...
                    'New Customers', 
                    'Seminar', 
                    'CRM Broiler', // <--- Penambahan Baru
                    'CRM DOC'      // <--- Penambahan Baru
                ];
