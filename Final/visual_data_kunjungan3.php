                        ...
                        <table class="table mb-0" id="dataTableVisitDetails">
                            <thead style="background-color: #f8f9fa; position: sticky; top: 0; z-index: 10;">
                                <tr>
                                    ...
                                    <th style="border-top: none; width: 80px;">Username</th>
                                    <th style="border-top: none; width: 90px;">Jenis Visit</th>
                                    <th style="border-top: none; width: 90px;">Nama Customer</th>
                                    <th style="border-top: none; width: 40px;" class="text-center">VIP</th>
                                    <th style="border-top: none; width: 70px;">Kapasitas</th>
                                    <th style="border-top: none; width: 85px;">Waktu</th>
                                    <th style="border-top: none; width: 80px;">Tujuan</th>
                                    <th style="border-top: none; width: 80px;">Kasus</th>
                                    <th style="border-top: none; width: 80px;">Pakan</th>
                                    <th style="border-top: none; width: 100px;">Alamat</th>
                                    <th style="border-top: none; width: 60px;" class="text-center">Lokasi</th>
                                </tr>
                            </thead>
...
@media (max-width: 768px) {
    ...
    /* Atur lebar kolom spesifik untuk tablet */
    #dataTableVisitDetails thead th:nth-child(1) { width: 18px !important; } /* Icon */
    #dataTableVisitDetails thead th:nth-child(2) { width: 60px !important; } /* Username */
    #dataTableVisitDetails thead th:nth-child(3) { width: 70px !important; } /* Jenis Visit */
    #dataTableVisitDetails thead th:nth-child(4) { width: 70px !important; } /* Nama Customer */
    #dataTableVisitDetails thead th:nth-child(5) { width: 30px !important; } /* VIP */
    #dataTableVisitDetails thead th:nth-child(6) { width: 50px !important; } /* Kapasitas */
    #dataTableVisitDetails thead th:nth-child(7) { width: 60px !important; } /* Waktu */
    #dataTableVisitDetails thead th:nth-child(8) { width: 60px !important; } /* Tujuan */
    #dataTableVisitDetails thead th:nth-child(9) { width: 60px !important; } /* Kasus */
    #dataTableVisitDetails thead th:nth-child(10) { width: 60px !important; } /* Pakan */
    #dataTableVisitDetails thead th:nth-child(11) { width: 80px !important; } /* Alamat */
    #dataTableVisitDetails thead th:nth-child(12) { width: 50px !important; } /* Lokasi */
}
...
@media (max-width: 576px) {
    ...
    /* Atur lebar kolom spesifik untuk mobile */
    #dataTableVisitDetails thead th:nth-child(1) { width: 15px !important; } /* Icon */
    #dataTableVisitDetails thead th:nth-child(2) { width: 50px !important; } /* Username */
    #dataTableVisitDetails thead th:nth-child(3) { width: 55px !important; } /* Jenis Visit */
    #dataTableVisitDetails thead th:nth-child(4) { width: 55px !important; } /* Nama Customer */
    #dataTableVisitDetails thead th:nth-child(5) { width: 25px !important; } /* VIP */
    #dataTableVisitDetails thead th:nth-child(6) { width: 40px !important; } /* Kapasitas */
    #dataTableVisitDetails thead th:nth-child(7) { width: 50px !important; } /* Waktu */
    #dataTableVisitDetails thead th:nth-child(8) { width: 50px !important; } /* Tujuan */
    #dataTableVisitDetails thead th:nth-child(9) { width: 50px !important; } /* Kasus */
    #dataTableVisitDetails thead th:nth-child(10) { width: 50px !important; } /* Pakan */
    #dataTableVisitDetails thead th:nth-child(11) { width: 65px !important; } /* Alamat */
    #dataTableVisitDetails thead th:nth-child(12) { width: 45px !important; } /* Lokasi */
    
    /* Pastikan table tidak overflow */
    .table-responsive {
        overflow-x: auto !important;
    }
    
    #dataTableVisitDetails {
        min-width: 600px; /* Total lebar minimum untuk mobile */
    }
}
...
@media (max-width: 400px) {
    ...
    #dataTableVisitDetails {
        min-width: 550px; /* Kurangi sedikit untuk layar sangat kecil */
    }
}
</style>
