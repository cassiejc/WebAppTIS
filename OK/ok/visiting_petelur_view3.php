...
<body>
    ...
    /**
     * Fungsi utama untuk refresh data farm via AJAX (DIPERBARUI)
     */
                    ...
                    try {
                        ...
                        if (newOptions && newOptions.length > 0) {
                            newOptions.forEach(o => {
                                ...
                                // Cek jika o.vip_farm ada, trim, dan samakan dengan 'Ya'
                                ...
                                optionDiv.dataset.vip_farm = vip_status; // <-- BARU DITAMBAHKAN
    ...
    document.getElementById('petelurForm').addEventListener('submit', async function(e) {
        ...
        if (currentSelectedKapasitas > 0) {
            ...
            if (tipeTernak === 'Layer') {
                ...
                // Logika petelur lain (Puyuh, Bebek, Arap)
                const efektifInput = document.querySelector('input[data-field="efektif_terisi_petelur"]');
                if (efektifInput) {
                    const valEfektif = efektifInput.value.replace(/,/g, '');
                    totalTerisi = parseInt(valEfektif, 10);
                    errorInput = efektifInput;
                }
            }
