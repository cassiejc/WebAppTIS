...
// GANTI FUNGSI INI DI M_Visual.php
public function get_kondisi_lingkungan_monthly($year, $user_id = null, $area_id = null, $selected_areas = []) { 
    $year = (int)$year;
    $where_clauses = []; 
    ...
    // [PERUBAHAN UTAMA] Tambahkan kolom jenis_pakan dan GROUP BY jenis_pakan
    $query_lalat = "
        SELECT
