...
public function visual_kondisi_lingkungan()
{
    ...
    public function get_kasus_data_for_area_ajax()
    {
        ...
        $kategori_chart = []; 
        $pivot_chart_data = [];
        // [UBAH] Sesuaikan pengambilan data: 'jumlah_kasus'
        foreach ($raw_count_data as $row) {
        ...
        $datasets = [];
        // Ganti warna jika ingin konsisten, tapi karena user minta jangan ubah warna, 
        // saya gunakan warna default yang ada di visual_kasus_penyakit()
        $colors = ['#28a745', '#ffc107', '#6f42c1', '#dc3545', '#fd7e14', '#17a2b8', '#6c757d'];
        $color_index = 0;
        ...
        foreach ($kategori_chart as $kat) {
            ...
            // Loop melalui 12 bulan master query format ('Jan 2025', 'Feb 2025', ...)
