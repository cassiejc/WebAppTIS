...
                                                <?php 
                                        ...
                                        ?>
                                                <span class="badge <?= $badge_class ?> px-3 py-2" style="font-size: 13px; border-radius: 20px;">
...
<style>
    ...
    .badge-info { /* Jamur: Biru */
        background-color: #17a2b8 !important; /* Menggunakan info untuk warna biru yang lebih baik */
        color: white;
    }
