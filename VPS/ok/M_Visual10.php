...
class M_Visual extends CI_Model {
    ...
    public function get_all_visit_details($start_date_str, $end_date_str, $user_id = null, $area_id = null) {
        ...
        foreach ($this->table_mapping as $kategori => $nama_tabel) {
            ...
            foreach ($desired_columns as $col) {
                if (in_array($col, $existing_columns)) {
                    ...
                    // Biarkan NULL, nanti akan di-handle oleh COALESCE
                    $select_parts[] = "NULL as {$col}"; 
                }
            }
            
            // Logika Pakan (TETAP SAMA, biarkan NULL jika tidak ada)
            ...
            // Logika Customer (TETAP SAMA, biarkan NULL jika tidak ada)
            ...
            // Logika Kapasitas (TETAP SAMA, biarkan NULL jika tidak ada)
            ...
            // --- [MODIFIKASI 1] Tambahkan logika VIP Farm ---
            if (in_array('vip_farm', $existing_columns)) {
                $select_parts[] = "t.vip_farm as vip_farm";
            } else {
                $select_parts[] = "NULL as vip_farm"; // Biarkan NULL, akan di-handle COALESCE
            }
            // --- Akhir Modifikasi 1 ---
        ...
        $select_parts[] = "NULL as vip_farm"; // [MODIFIKASI 2] Tambahkan kolom vip_farm
        ...
        // --- Tambahkan Query untuk SAMPLE ---
        $sample_cols = $get_cols('sample_form');
        $select_parts = [
            "u.username",
            "u.master_area_id",
            "'Kirim Sample' as kategori_visit",
            "t.waktu_kunjungan"
        ];
        ...
        $select_parts[] = "NULL as kapasitas";
        $select_parts[] = "NULL as vip_farm"; // [MODIFIKASI 3] Tambahkan kolom vip_farm
        ...
        // --- Tambahkan Query untuk NEW CUSTOMER (master_farm) ---
        ...
        // --- Tambahkan Query untuk NEW CUSTOMER (master_subagen) ---
        ...
        $select_parts[] = "NULL as kapasitas";
        $select_parts[] = "NULL as vip_farm"; // [MODIFIKASI 5] Tambahkan kolom vip_farm
        ...
        // --- Tambahkan Query untuk NEW CUSTOMER (master_kemitraan) ---
        ...
        $select_parts[] = "NULL as kapasitas";
        $select_parts[] = "NULL as vip_farm"; // [MODIFIKASI 6] Tambahkan kolom vip_farm
