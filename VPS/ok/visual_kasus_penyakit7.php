...
                                <tr>
                                    <th style="width: 50px; border-top: none;" class="text-center">#</th>
                                    <th style="width: 25%; border-top: none;">Waktu & Tanggal</th>
                                    <th style="width: 30%; border-top: none;">Nama Farm</th>
...
                                                <td class="text-center">
                                                    <?php 
                                                    // Baris 111 yang error, pastikan spasi di sini adalah spasi normal
                                                    $nilai = $area_data[$kategori] ?? 0;
                                                    $badge_class = $nilai > 0 ? 'badge-primary' : 'badge-light';
                                                    ?>
                                                    <span class="badge <?= $badge_class ?> px-3 py-2" style="font-size: 13px; min-width: 50px;">
...
    }
    ...
    /* === Warna Kustom untuk Badge Kasus === */
...
        background-color: #007bff !important; /* Diubah ke biru yang lebih standar (sebelumnya #17a2b8) */
        color: white;
    }
