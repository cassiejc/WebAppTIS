...
public function visual_harga_gabungan()
    ...
    // BARU: Fungsi untuk Laporan Harga Komoditas (satu per satu)
    public function visual_harga($jenis_komoditas = 'telur')
    {
        $data['user'] = $this->dash->getUserInfo($this->session->userdata('token'))->row_array();
        $data["title"] = "Laporan Harga Komoditas";
        ...
        // Mapping untuk ambil harga hari ini
        $mapping_jenis = [
            'telur' => 'harga_jual_telur_layer',
            'jagung' => 'harga_jagung',
            'katul' => 'harga_katul',
        ...
        // Load View
        $this->load->view('templates/dash_h', $data);
        $this->load->view('visual_harga_view', $data); // <-- Memuat view baru Anda
        $this->load->view('templates/dash_f', $data);
    }
