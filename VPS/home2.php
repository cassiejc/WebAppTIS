    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        <i class="fas fa-chart-area fa-3x mb-3 text-success"></i>
                        <h5 class="card-title font-weight-bold">Laporan Harga (Gabungan)</h5>
                        <p class="card-text">Grafik harga satuan & perbandingan komoditas.</p>
                        <a href="<?= base_url('Dashboard_new/visual_harga_gabungan') ?>" class="btn btn-success">Buka Laporan</a>
                    </div>
                </div>
            </div>
