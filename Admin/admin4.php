...
class Admin_Controller extends CI_Controller {
    ...
    public function target($id = null) {
        ...
        // Gunakan alur generik untuk menampilkan form update
        // Argumen kedua adalah 'page' yang akan dicari di tabel 'questions'
    ...
    private function _update_data($kategori, $update_data, $user, $page, $id, $existing_data) {
        switch($kategori) {
            ...
            case 'Target':
                $this->M_target->update_target($id, $update_data);
                break;
    ...
    private function _get_data_list($kategori, $user) {
        switch($kategori) {
            ...
            case 'Target':
                return [
                    'data' => $this->M_target->get_all_targets(),
