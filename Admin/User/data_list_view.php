...
<body>
    <div class="container-fluid">
        ...
        <div class="table-container">
            <div class="row mb-3">
                <div class="col-md-6">
                    <?php if (isset($kategori_selected) && $kategori_selected == 'Target'): ?>
                        <a href="<?= site_url('Admin_Controller/add_target') ?>" class="btn btn-success mb-3">
            ...
            $method_name = $kategori_to_method[$kategori_selected] ?? strtolower(str_replace(' ', '_', $kategori_selected));
            ?>
                            ...
                            <?php foreach ($data_list as $data): ?>
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <a href="<?= base_url('Admin_Controller/' . $method_name . '/' . $data[$primary_key]) ?>" 
    ...
    <script>
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (deleteId) {
                window.location.href = '<?= base_url('Admin_Controller/delete_data/') ?>' + 
