                ...
                <?php foreach ($questions_kategori as $q): ?>
                    <div class="question-group <?= (in_array($q['field_name'], ['agen_dari', 'sub_agen_dari', 'kemitraan_dari'])) ? 'dependent-field' : '' ?>" 
                        ...
                        if ($kategori_selected == 'Pakan'):
                            ...
                            <?php elseif ($q['field_name'] == 'layer_pakai_pakan_cp'): ?>
                                data-pakan-cp="true" style="display: none;"
                            <?php elseif ($q['field_name'] == 'layer_selain_pakan_cp'): ?>
        ...
        function toggleLayerPakanFields(selectedValue) {
            ...
            if (selectedValue === 'CP') {
                ...
                if (cpField) {
                    ...
                    const qData = window.questionsData.find(q => q.field_name === 'layer_pakai_pakan_cp');
                    if (qData && qData.required == '1') {
                ...
                if (nonCpField) {
                    ...
                    const qData = window.questionsData.find(q => q.field_name === 'layer_selain_pakan_cp');
                    if (qData && qData.required == '1') {
