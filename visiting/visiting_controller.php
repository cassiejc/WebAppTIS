    ...
    public function index() {
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($action === 'next') {
                ...
                //  } elseif ($livestock_type === 'Bebek Pedaging') {
                //      error_log("Redirecting to Bebek_Pedaging_Controller");
                //      redirect('Bebek_Pedaging_Controller/index');
                ...
                if($livestock_type === 'Pedaging') {
                     error_log("Redirecting to Visiting_Pedaging_Controller");
                     redirect('Visiting_Pedaging_Controller/index');
                 } elseif ($livestock_type === 'Petelur') {
                     error_log("Redirecting to Visiting_Petelur_Controller");
                     redirect('Visiting_Petelur_Controller/index');
                 } else {
